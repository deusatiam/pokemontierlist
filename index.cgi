...
print ('<button id="Vote1" type="button" method="post" action="functions.py"> Vote for me! </button>')
print ('</div>')
...
print ('<button id="Vote2" type="button" method="post" action="functions.py"> Vote for me! </button>')
print ('</div>')
print ('</div>')
print ('</body>')
print ('</html>')
