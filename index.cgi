...
print ('<button id="Vote1" type="button" method="post" action="' + func.vote(pokemon1,pokemon2) + '"> Vote for me! </button>')
print ('</div>')
...
print ('<button id="Vote2" type="button" method="post" action="' + func.vote(pokemon2,pokemon1) + '"> Vote for me! </button>')
print ('</div>')
print ('</div>')
print ('</body>')
print ('</html>')
