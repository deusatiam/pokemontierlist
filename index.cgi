...
print('<img src="' + func.get_sugimori(pokemon1) + '" onclick="' + func.vote(pokemon1, pokemon2) + '" style="width:300px;height:300px;">')
print ('</div>')
print ('<div class="Pokemon2">')
print ('<h2> ' + func.get_name(pokemon2) + ' </h2>')
print('<img src="' + func.get_sugimori(pokemon2) + '" onclick="' + func.vote(pokemon2, pokemon1) + '" style="width:300px;height:300px;">')
print ('</div>')
print ('</div>')
print ('</body>')
print ('</html>')
